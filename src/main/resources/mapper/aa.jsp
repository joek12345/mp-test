...
<div class="slider">
    <ul>
        ...
        <li id="current"><a href="#"><img src="images/lunbo/4.jpg" alt=""></a></li>
...
<div class="jumbotron" style="background-color: bisque;box-shadow: 0px -2px 10px #d0cccc inset;margin-bottom: -1px;">
    <div class="container" style="padding-left: 60px">
        <h1 class="display-3">你的の美食推荐<small style="font-size: 20px;">打造我们自己的美食圈！</small></h1>
        <p style="margin-top: 2rem;">
            美食推荐致力于让人更会做 科学的饮食建议，可视化的营养信息，丰富的菜谱内容。 </p><br><br>
        <p>
            <a target="_blank" href="foodlist" class="btn btn-primary btn-lg" role="button">浏览美食? Go!</a>
        </p>
    </div>
</div>
...
<div class="CT">
    <div class="content">
        <div style="font-size: 30px;margin-bottom:50px;padding-top: 50px;"><i class="fa fa-clock-o fa-2x"></i><strong>${user.username}1你的一天食谱</strong></div>
        <c:if test="${user.tanghuadanbai > 150}">
            <div class="content_c1">
                ...
                <div class="ctime2">
                    ...
                    <div class="time_2" onmouseover="change1(this,2)">晚餐时间</div>
                </div>
            </div>
        </c:if>
        <c:if test="${user.tanghuadanbai < 140}">
            <div class="content_c1">
                <div class="ctime1">
                    <!--4点到10点-->
                    <div class="time_1" style="display: block">
                ...
                <div class="ctime2">
                    <div class="time_2" onmouseover="change1(this,0)">早餐时间</div>
                    <div class="time_2" onmouseover="change1(this,1)">午餐时间</div>
                    <div class="time_2" onmouseover="change1(this,2)">晚餐3时间</div>
                </div>
            </div>
        </c:if>
        ...
        <div class="bot_f">
            ...
            <div class="bot_f2">
                <ul>
                    <li>
                        <div>
                            <img src="images/wan/bottom/weibo.png">
                            <a class="iig"><span>关注：99999万</span></a>
                        </div>
                        <a target="_blank" href="https://e.weibo.com/KeyG24" class="bot_fa">
                            <span>点击进入<br>官方微博</span>
                        </a>
                    </li>
                    <li>
                        <div>
                            <img src="images/wan/bottom/QQkongjian.png">
                            <a class="iig"><span>关注：999.9万</span></a>
                        </div>
                        <a target="_blank" href="https://user.qzone.qq.com/12345678" class="bot_fa">
